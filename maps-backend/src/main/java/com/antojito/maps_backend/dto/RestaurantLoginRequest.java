...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Payload de login para owner de restaurante")
public class RestaurantLoginRequest {
    ...
    @Schema(description = "Mail del owner", example = "owner.sabor@antojitosmaps.com")
    private String mail;

    @NotBlank(message = "La password es obligatoria")
    @Size(max = 255, message = "La password no puede exceder 255 caracteres")
    @Schema(description = "Password del owner", example = "OwnerSabor2026!")
